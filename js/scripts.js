...
const swiper2 = document.querySelector('.swiper__container');
const swiper3 = document.querySelector('.--swipe');
...
const playBtn = document.querySelectorAll('.main-slider__play');
